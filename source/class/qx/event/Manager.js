  ...
  members: {
    ...
    */
    ...
    removeListener(target, type, listener, self, capture) {
      ...
      if (!listener.$$unique) {
        // ?? Cannot remove if unique value not given
        return false;
      }
      ...
      var entry = entryMap.get(listener.$$unique);
      if (entry) {
